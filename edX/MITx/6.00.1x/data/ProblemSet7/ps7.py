...
class SubjectTrigger(WordTrigger):
    ...
    def info(self):
        print 'SubjectTrigger: ', self.word
...
class SummaryTrigger(WordTrigger):
    ...
    def info(self):
        print 'SummaryTrigger: ', self.word
...
class OrTrigger(Trigger):
    ...
    def info(self):
        print '>> OrTrigger:'
        print self.trigger_1.info()
        print self.trigger_2.info()
...
class PhraseTrigger(Trigger):
    ...
    def info(self):
        print 'PhraseTrigger:', self.phrase
...
def main_thread(master):
    ...
    try:
        ...
        triggerlist = readTriggerConfig("/home/roger/Workspace/MOOC/edx/MITx/data/ProblemSet7/triggers.txt")
